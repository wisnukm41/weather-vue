    ...
    <div class="flex flex-col items-center flex-1">
        ...
        <div class="w-full max-w-screen-md py-12">
            <div class="mx-8 text-white">
                ...
                <div class="flex flex-col gap-10 overflow-x-scroll">
        ...
        <div class="flex items-center gap-2 py-12 text-white duration-150 cursor-pointer hover:text-red-500" @click="removeCity">
...
const apiKey = import.meta.env.VITE_OPENW_API
const getWeather = async () => {
    try {
        const weatherData = await axios.get(`https://api.openweathermap.org/data/3.0/onecall?lat=${route.query.lat}&lon=${route.query.lon}&APPID=${apiKey}&units=imperial`);
